...
namespace SkyDriveBrowser.ViewModels
{
    public class SkyDriveFileViewModel
    {
        public SkyDriveFileViewModel()
        {
            this.Items = new ObservableCollection<FileInfo>();
        }

        /// <summary>
        /// A collection for ItemViewModel objects.
        /// </summary>
        public ObservableCollection<FileInfo> Items { get; private set; }
